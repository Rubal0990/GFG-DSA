...
<p><span style="font-size: 18px;"><strong>Constraints:</strong></span><br><span style="font-size: 18px;"><li><code>n == chairs.length == passengers.length</code></li></span><br><span style="font-size: 18px;"><li><code>1 &lt;= n &lt;= 10^5</code></li></span><br><span style="font-size: 18px;"><li><code>1 &lt;= chairs[i], passengers[j] &lt;= 100</code></li></span></p>
<p>&nbsp;</p></div>
